...
import { signUpStudent } from "../actions/sign-up-student";

export function SignUpStudentForm({ defaultEntryCode }: { defaultEntryCode?: string }) {
  const [state, formAction, pending] = useActionState(signUpStudent, IDLE_ACTION_STATE);
